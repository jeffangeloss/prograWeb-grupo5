...
function TablaAdmin() {
    ...
    return <div className="border border-blue-900/50 mt-10 mx-8 rounded-2xl shadow-xl overflow-hidden">
            ...
            <tbody className="divide-y divide-blue-900/50">
                <tr className="hover:bg-gray-500/50 transition">
                    ...
                    <td className="px-6 py-4 text-right">
                        <button className="px-3 py-1.5 text-xs rounded-md bg-orange-300/30 text-orange-300 border border-orange-500/30 hover:bg-orange-500/30 transition"
        ...
        <span className="p-3 text-xs flex justify-end">Usuarios: 2</span>
    </div>
}
