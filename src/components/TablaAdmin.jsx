...
function TablaAdmin({ usuarios }) {
    ...
    return <div className="mt-10 mx-4 rounded-2xl shadow-2xl">
        <div className="overflow-x-auto scroll rounded-2xl">
            <table className="text-xs bg-[#7d7493]/25 text-slate-600 text-left min-w-full">
