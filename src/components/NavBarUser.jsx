...
function NavBarUser() {
    ...
    return <div className="bg-slate-100 px-4 py-3 sm:px-6 sm:py-4 shadow-md flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
            <button
                type="button"
                className="px-6 py-2.5 rounded-full border border-blue-900/30 text-blue-900 hover:bg-blue-900/10 transition">Cambiar contraseña
